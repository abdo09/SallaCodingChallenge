...
class CirclePagerIndicatorDecoration : ItemDecoration() {
    ...
    private fun drawInactiveIndicators(c: Canvas, indicatorStartX: Float, indicatorPosY: Float, itemCount: Int) {
        mPaint.color = colorInactive.toColorInt()
    ...
    private fun drawHighlights(c: Canvas, indicatorStartX: Float, indicatorPosY: Float,
        ...
        mPaint.color = colorActive.toColorInt()
        ...
        if (progress == 0f) {
            ...
            val partialLength: Float = mIndicatorItemLength * progress + mIndicatorItemPadding * progress
